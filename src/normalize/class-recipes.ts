...
const BARE_UTILITIES = new Set([
  'flex', 'grid', 'block', 'inline', 'inline-flex', 'inline-block', 'inline-grid', 'hidden', 'table',
  'contents', 'flow-root', 'list-item', 'absolute', 'relative', 'fixed', 'sticky', 'static', 'isolate',
  'container', 'truncate', 'italic', 'not-italic', 'uppercase', 'lowercase', 'capitalize', 'normal-case',
  'underline', 'overline', 'line-through', 'no-underline', 'antialiased', 'subpixel-antialiased',
  'visible', 'invisible', 'collapse', 'transform', 'filter', 'transition', 'resize', 'appearance-none',
  'sr-only', 'not-sr-only', 'border', 'rounded', 'shadow', 'ring', 'outline', 'blur', 'grayscale',
  'invert', 'sepia', 'overflow-hidden', 'overflow-auto', 'overflow-scroll', 'overflow-visible',
  'shrink', 'grow', 'wrap', 'nowrap', 'group', 'peer', 'dark',
])
...
const UTILITY_PREFIXES = new Set([
  ...
  'top', 'right', 'bottom', 'left', 'inset', 'z', 'order', 'basis', 'grow', 'shrink', 'flex',
  'col', 'row', 'gap', 'gap-x', 'gap-y', 'space-x', 'space-y', 'divide', 'divide-x', 'divide-y',
  'justify', 'items', 'content', 'self', 'place', 'grid-cols', 'grid-rows', 'auto-cols', 'auto-rows',
  'text', 'font', 'leading', 'tracking', 'indent', 'align', 'whitespace', 'break', 'line-clamp', 'list',
  'bg', 'from', 'via', 'to', 'fill', 'stroke', 'border', 'rounded', 'outline', 'ring', 'shadow',
  'opacity', 'mix', 'blur', 'backdrop', 'brightness', 'contrast', 'saturate', 'drop', 'mask',
  'transition', 'duration', 'ease', 'delay', 'animate', 'translate', 'rotate', 'scale', 'skew', 'origin',
  'cursor', 'select', 'resize', 'scroll', 'snap', 'touch', 'pointer', 'overflow', 'overscroll',
  'object', 'aspect', 'columns', 'float', 'clear', 'decoration', 'underline', 'caret', 'accent',
  'placeholder', 'appearance', 'will', 'first', 'last', 'backdrop-blur',
])

const TAILWIND_PALETTE = new Set([
  'slate', 'gray', 'zinc', 'neutral', 'stone', 'red', 'orange', 'amber', 'yellow', 'lime', 'green',
  'emerald', 'teal', 'cyan', 'sky', 'blue', 'indigo', 'violet', 'purple', 'fuchsia', 'pink', 'rose',
  'white', 'black', 'transparent', 'current', 'inherit', 'auto', 'none', 'full', 'screen', 'min', 'max',
  'fit', 'px', 'reverse', 'wrap', 'nowrap', 'hidden', 'visible', 'scroll', 'clip', 'cover', 'contain',
  'center', 'left', 'right', 'start', 'end', 'between', 'around', 'evenly', 'top', 'bottom', 'middle',
  'baseline', 'stretch', 'col', 'row', 'normal', 'bold', 'medium', 'semibold', 'light', 'thin',
  'extrabold', 'black', 'extralight', 'italic', 'solid', 'dashed', 'dotted', 'double', 'wide', 'wider',
  'widest', 'tight', 'tighter', 'snug', 'relaxed', 'loose', 'first', 'last', 'only', 'both',
