...
export const OVERLAY_PREVIEW_PHONE_MAX = 430
export const OVERLAY_PREVIEW_TABLET_MAX = 1024
export const OVERLAY_PREVIEW_DESKTOP_MAX = 1280
export const OVERLAY_PREVIEW_MAX = 1280
