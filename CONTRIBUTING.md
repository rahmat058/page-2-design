...
- **Docs** — README and [ARCHITECTURE.MD](./ARCHITECTURE.MD) stay in sync: install and test in README, pipeline and folders in architecture. Chrome Web Store copy lives in [STORE.md](./STORE.md). Published listing: [Page2Design](https://chromewebstore.google.com/detail/page2design/mghjckjmfhadbceeaoigeglhbojeomjc).
